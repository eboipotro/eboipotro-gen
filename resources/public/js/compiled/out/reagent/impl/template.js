...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17088__auto__,writer__17089__auto__,opt__17090__auto__){
return cljs.core._write.call(null,writer__17089__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16490__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16490__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16490__auto__)){
return or__16490__auto__;
} else {
...
var G__23875 = o;
(G__23875[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__23876__delegate = function (args){
...
while (G__23877__i < G__23877__a.length) {G__23877__a[G__23877__i] = arguments[G__23877__i + 0]; ++G__23877__i;}
  args = new cljs.core.IndexedSeq(G__23877__a,0);
} 
...
var args = cljs.core.seq(arglist__23878);
...
var old_23879 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23879))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23879)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__16478__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23882 = jsprops;
(G__23882["defaultValue"] = value);

(G__23882["onChange"] = ((function (G__23882,v,value,on_change){
return (function (p1__23880_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23880_SHARP_);
});})(G__23882,v,value,on_change))
);
...
var vec__23884 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23884,(0),null);
var id = cljs.core.nth.call(null,vec__23884,(1),null);
var class$ = cljs.core.nth.call(null,vec__23884,(2),null);
...
var temp__4427__auto__ = (function (){var G__23886 = cljs.core.meta.call(null,v);
...
var jsprops = {"argv": v};
var G__23888_23889 = v;
var G__23888_23890__$1 = (((G__23888_23889 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23888_23889));
var G__23888_23891__$2 = (((G__23888_23890__$1 == null))?null:(jsprops["key"] = G__23888_23890__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__23894 = cljs.core.meta.call(null,argv);
var G__23894__$1 = (((G__23894 == null))?null:reagent.impl.template.get_key.call(null,G__23894));
return G__23894__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__23895 = (((jsprops == null))?{}:jsprops);
(G__23895["key"] = key);
...
var n__17393__auto___23896 = a.length;
var i_23897 = (0);
while(true){
if((i_23897 < n__17393__auto___23896)){
(a[i_23897] = reagent.impl.template.as_element.call(null,(a[i_23897])));
...
var a = cljs.core.into_array.call(null,s);
var n__17393__auto___23899 = a.length;
var i_23900 = (0);
while(true){
if((i_23900 < n__17393__auto___23899)){
var val_23901 = (a[i_23900]);
if((cljs.core.vector_QMARK_.call(null,val_23901)) && ((reagent.impl.template.key_from_vec.call(null,val_23901) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23900] = reagent.impl.template.as_element.call(null,val_23901));
...
var G__23904 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23904) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23904){
...
//# sourceMappingURL=template.js.map?rel=1441510897213